...
- **Round 3 = overnight soak:** same config, `WFM_TS=3 debug:sim -- 30` wrapped in `caffeinate -is`, run unattended overnight for a trustworthy parity number + rare-bug soak across ~30 match resets. Results appended below when read.
