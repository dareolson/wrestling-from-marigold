...
export const POSES = {
    ...
    theszIdle:      { lLeg:-0.01,  rLeg: 0.14,  lArm: 0.10,  rArm: 0.07, lean: 0.05, crouch: 0.05 }, // slight forward lean (Derek rig-tuner pass 2026-07-14, second same-day export); legs no longer equal — both legs render visible (see thesz.js's far-leg-offset comments), not stacked/hidden
